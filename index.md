...
<link href="/css/DefaultResume-RTL.css?v=1PYlmae0uSNzKKkKjAVQCI9t6LKjVRn9emL-EU9l8Fo" rel="stylesheet">
...
<style>
    ...
    <link href="/css/credit-header.css?v=8E_nvcWZSOwQeObjGvSEykg_3q-pU_m3Dwv3WXrrJdY" rel="stylesheet">
        <header>
            <a href="/">
                <img src="/images/svg/mainLogo.svg" width="125" height="35" alt="cvbuilder.me">
            </a>
        </header>
...
<script>
    ...
    <div class="container preview-container" style="height: 1281px;">
        <div class="contact-info">
            <div class="name-job-desc">
                <div class="user-image" style="background-image:url('/Files/User_Photo/a1dc681b-0328-4a5c-99a5-c1484712570a/UjdB9DRdlkiMs44czIWsVw-259.jpg')"></div>
...
.property-item_head {
  font-size: 1.1rem;
  border-bottom: 1px solid #1170cd;
  text-align: center;
  width: 50%;
  margin: AUTO;
  clear: both;
